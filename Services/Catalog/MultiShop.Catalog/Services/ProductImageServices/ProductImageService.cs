...
namespace MultiShop.Catalog.Services.ProductImageServices
{
    public class ProductImageService : IProductImageService
    {
        ...
        {
            var values = _mapper.Map<ProductImage>(updateProductDto);
            await _productImageCollection.FindOneAndReplaceAsync(x => x.ProductImageId == updateProductDto.ProductImageId, values);
        }
    }
}
